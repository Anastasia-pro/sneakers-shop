        ...
        <div className="overlay">
            <div className="drawer">
                <h2 className="d-flex justify-between mb-30">Корзина
                    <img onClick={onClose} className="remove-btn cu-p" src="imgs/btn-remove.svg" alt="close-btn" />
                </h2>

                {
                    items.length > 0 ?
                        <div className="d-flex flex-column flex"> <div className="items">
                            {items.map((obj) => (
                                <div key={obj.id} className="cart-item d-flex align-center mb-20">
                                    ...
                                    <img onClick={() => onRemove(obj.id)} className="remove-btn" src="imgs/btn-remove.svg" alt="remove-btn" />
                                </div>
                            ))}
                        </div>
                            ...
                            <div className="cart-total__block">
                                ...
                                <button disabled={isLoading} onClick={onClickOrder} className="green-btn">Оформить заказ
                                    <img src="/imgs/arrow.svg" alt="arrow"></img>
                                </button>
                            </div></div>
                        ...
                        <Info
                            ...
                            image={isOrderComplete ? "/imgs/complete-order.jpg" : "/imgs/empty-cart.jpg"} />
                }
